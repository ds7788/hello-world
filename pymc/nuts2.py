from step_methods.quadpotential import *
from step_methods.arraystep import *
from core import *
from numpy import exp, log
from numpy.random import uniform
from step_methods.hmc import leapfrog, Hamiltonian, bern, energy
from tuning import guess_scaling
from __builtin__ import sum as bsum


class NUTS2(ArrayStep):
    """
    ...
    """
    def __init__(self, vars=None, potential=None, step_scale = .25, is_cov = False, state = None,
                 Emax = 1000,
                 target_accept = .65,
                 gamma = .05,
                 k =.75,
    ...
    def astep(self, q0, logp, dlogp):
        ...
        if self.m %10==0:
            self.potential.lbfgs.update(q, logp(q), dlogp(q))
